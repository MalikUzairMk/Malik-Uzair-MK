...
def logo():
    ...
    return (gn + figlet)
print (logo())
print (bl + "[-] Powered by MALIK UZAIR MK")
print (gn + "[+] Made By Malik Uzair MK")
...
def genscard():
    ...
    return (gn + "[-] Brand : %s\n[-] Card Number : %s\n[-] Bank : %s\n[-] Name : %s\n[-] Address : %s\n[-] Country : %s\n[-] Money Range : %s\n[-] CVV : %s\n[-] Expiry : %s\n[-] Pin : %s\n============================\n[*] Telegram Channel : @MalikMods768" % (card['IssuingNetwork'] , card['CardNumber'] , card['Bank'] , card['Name'] , card['Address'] , card['Country'] , card['MoneyRange'] , card['CVV'] , card['Expiry'] , card['Pin']) + cv)
...
if opr == "1":
    ...
    print (mag + "[$] YouTube Channel : @MalikMods768" + cv)
